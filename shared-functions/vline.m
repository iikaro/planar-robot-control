...
if length(x)>1  % vector input
    ...
    if length(label)
        ...
        xunit=(x-xx(1))/xrange;
        if xunit<0.8
            text(x+0.01*xrange,y(2)+0.1*(y(1)-y(2)),label,'color',[17 17 17]/255)%up
            %text(x+0.01*xrange,y(1)+0.1*(y(2)-y(1)),label,'color',get(h,'color'))%down
        else
            text(x-.05*xrange,y(2)+0.1*(y(1)-y(2)),label,'color',[17 17 17]/255)%up
            %text(x-.05*xrange,y(1)+0.1*(y(2)-y(1)),label,'color',get(h,'color'))%down
        end
    end     
